...
chứng thống kê để bác bỏ giả thuyết $H_0$ rằng kỳ vọng của giá trị xấp xỉ bằng
với giá trị kernel lý thuyết. Kết quả phù hợp với mệnh đề
\ref{prop:expect-real-kernel}, khẳng định rằng kỳ vọng tích vô hướng  của ánh
...
Fourier Ngẫu nhiên trong việc xấp xỉ các \tr{kernel}.
